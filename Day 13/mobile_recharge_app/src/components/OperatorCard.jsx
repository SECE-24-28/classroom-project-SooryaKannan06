...
export default function OperatorCard({ name, logo, operator }) {
  ...
  return (
    <div
      ...
      style={{
        border: "2px solid #8b8888ff",
        borderRadius: "16px",
        padding: "30px 20px",
        textAlign: "center",
        cursor: "pointer",
        transition: "all 0.3s ease",
        backgroundColor: "#cacfd49f",
      ...
      onMouseEnter={(e) => {
        ...
        e.currentTarget.style.borderColor = "#d21919ff";
      }}
      onMouseLeave={(e) => {
    ...
    >
      ...
      <p style={{ margin: "8px 0 0 0", color: "#060000ff", fontSize: "14px" }}>Select Plans</p>
    </div>
  );
}
